...
# Parsing + Configuration Script – FMC130A1 - Rev. A

This **Parsing + Configuration** script is designed for the **FMC130A1** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – FMC130A1 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **FMC130A1** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
