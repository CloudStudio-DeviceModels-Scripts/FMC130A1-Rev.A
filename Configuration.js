...
{
   endpoints.addEndpoint("1", "TEMP-", endpointType.temperatureSensor);
   endpoints.addEndpoint("3", "TEMP2-", endpointType.temperatureSensor);
   endpoints.addEndpoint("2", "GPS-POS", endpointType.locationTracker);
}
